...
import FAQClient, { CompactFAQ } from '@/components/FAQClient';

export const dynamic = 'force-static';

// Top 5 compact FAQs with short summaries to keep the client bundle under 10KB
const topFaqs: CompactFAQ[] = [
  {
    question: "What is MapifyIt?",
    answer: "An AI-powered mapping and GIS platform for enterprise teams."
  },
  {
    question: "Can it work offline?",
    answer: "Yes, MapifyIt runs in low-bandwidth or offline environments."
  },
  {
    question: "How is it different from Google Maps?",
    answer: "Built for localization, data sovereignty, and flexible deployment."
  },
  {
    question: "Is it scalable?",
    answer: "Yes, designed for large enterprise workloads and mission-critical ops."
  },
  {
    question: "How does pricing work?",
    answer: "Transparent usage-based pricing - no hidden fees."
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="space-y-16">
              <FAQClient faqs={topFaqs} defaultOpenFirst />
