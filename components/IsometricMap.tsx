...
export default function IsometricMap() {
    return (
        <div className="mt-20 relative mx-auto max-w-5xl h-[450px] rounded-3xl border border-white/10 bg-[#070B14]/60 backdrop-blur-xl overflow-hidden shadow-2xl group [perspective:2000px]">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-[800px] h-[800px] isometric-grid relative transition-transform duration-1000 group-hover:rotate-x-[55deg] group-hover:scale-105">
            ...
            <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end z-30 pointer-events-none">
                <div className="bg-[#03060D]/80 border border-white/10 p-4 rounded-xl backdrop-blur-md animate-[float_4s_ease-in-out_infinite]">
                    <div className="text-xs text-slate-400 font-mono mb-1">LAT / LNG</div>
                    <div className="text-sm text-blue-400 font-mono tracking-wider">34.0522° N, 118.2437° W</div>
                </div>
                <div className="bg-[#03060D]/80 border border-emerald-500/20 p-4 rounded-xl backdrop-blur-md flex items-center gap-3 animate-[float_5s_ease-in-out_infinite_0.5s]">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_10px_#10b981]" />
                    <span className="text-xs font-bold text-white tracking-widest uppercase text-[10px]">Engine Online</span>
                </div>
            </div>
        </div>
    );
