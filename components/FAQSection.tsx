  ...
  return (
    <section id={category.id} className="scroll-mt-32">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-xs text-blue-300 font-bold">
          FAQ
        </div>
        ...
        {category.faqs.map((faq, index) => (
          ...
          >
            <summary className="list-none cursor-pointer px-5 py-4 flex items-center justify-between text-left text-white text-base md:text-lg font-medium">
              ...
              <span className="text-slate-400 text-sm transition-transform duration-300 group-open:rotate-180">▼</span>
            </summary>
